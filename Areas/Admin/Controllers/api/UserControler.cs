...
using ProjectWebApp.Entities;
using ProjectWebApp.Helpers;
...
namespace ProjectWebApp.Areas.Admin.Controllers.api
{
    ...
    public class UserControler : ControllerBase
    {
        ...
        public async Task<object> Authenticate([FromBody] ApiUser apiUser)
        {
            ...
            {
                CustomUser customUser = _userManager.Users.SingleOrDefault(r => r.Klant.Email == apiUser.Username);
        ...
        private string GenerateJwtToken(string email, CustomUser user)
        {
            ...
            SecurityTokenDescriptor tokenDescriptor = new SecurityTokenDescriptor
            {
                Subject = new ClaimsIdentity(new Claim[]
                {
                   ...
                   new Claim(ClaimTypes.Name, user.Klant.ToString()),
